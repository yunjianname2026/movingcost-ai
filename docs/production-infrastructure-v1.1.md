...
| Field | Value |
|-------|-------|
| Document | Production Infrastructure Manual v1.1 |
| Status | Effective |
| Based On | `docs/production-infrastructure-v1.0.md` (audit 2026-07-11) |
| Manual Date | 2026-07-13 |
...
| Startup Lab application submit | ✅ Production | `startup-lab-apply.html`, `api/startup-lab-apply.js`, Supabase `startup_lab_applications` |
...
| — | — | — |
| Startup Lab | **Next** | Apply flow live; program expansion continues |
| — | — | — |
...
*Official production infrastructure manual for MovingCOST.ai. Update via new version file (v1.2+) when infrastructure facts change; do not silently rewrite history in older versions.*
